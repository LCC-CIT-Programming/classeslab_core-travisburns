    ...
    public class Deck
    {
        ...
        public Deck()
        {
            ...
            for (int value = 1; value <= 13; value++)
                // in each of 4 suits - in the case of dominoes, above represents one side(side 1) 0, 1, 2, 3, 4, ...maxDots -rows
                    //in the case of dominouoes below equals the other side(side 2) 0, ....maxDots - columns 
